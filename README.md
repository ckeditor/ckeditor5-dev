...
| Package                                                                                    | Version                                                                                                                                                             |
|--------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`@ckeditor/ckeditor5-dev-build-tools`](/packages/ckeditor5-dev-build-tools)                   | [![npm version](https://badge.fury.io/js/%40ckeditor%2Fckeditor5-build-tools.svg)](https://www.npmjs.com/package/@ckeditor/ckeditor5-dev-build-tools)                   |
...
| [`@ckeditor/ckeditor5-license-checker`](/packages/ckeditor5-license-checker)                             | [![npm version](https://badge.fury.io/js/%40ckeditor%2Fckeditor5-license-checker.svg)](https://www.npmjs.com/package/@ckeditor/ckeditor5-license-checker)                         |
| [`@ckeditor/ckeditor5-manual-server`](/packages/ckeditor5-manual-server)                             | [![npm version](https://badge.fury.io/js/%40ckeditor%2Fckeditor5-manual-server.svg)](https://www.npmjs.com/package/@ckeditor/ckeditor5-manual-server)                         |
