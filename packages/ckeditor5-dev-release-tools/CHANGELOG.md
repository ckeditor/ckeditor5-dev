...
# Changes for old package: `@ckeditor/ckeditor5-dev-env`

Previously this package was called `@ckeditor/ckeditor5-dev-env`. It was split in two smaller packages: `@ckeditor/ckeditor5-dev-release-tools` and `@ckeditor/ckeditor5-dev-transifex`.
