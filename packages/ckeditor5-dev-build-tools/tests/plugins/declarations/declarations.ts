...
describe( 'declarationFiles()', () => {
	it( 'Emits declaration files for TypeScript source files', async () => {
	...
	it( 'Allows emitting internal APIs in declaration files', async () => {
		isolatedDeclarationMock.mockResolvedValue( {
			errors: [],
			code: 'export declare const value: string;'
		} );
	...
	it( 'Throws formatted declaration generation errors', async () => {
