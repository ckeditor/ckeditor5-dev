...
import { getReleasePackagesPkgJsons } from '../../src/utils/getreleasepackagespkgjsons';
import fsExtra from 'fs-extra';
import upath from 'upath';
import { findPathsToPackages } from '../../src/utils/findpathstopackages';
...
describe('getReleasePackagesPkgJsons', () => {
	...
	it('should correctly retrieve package.json files from local and external repositories', async () => {
		...
		vi.mocked(upath.join).mockImplementation((...args: string[]) => args.join('/'));
