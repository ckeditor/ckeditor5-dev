...
![Dependency Status](https://img.shields.io/librariesio/release/npm/@ckeditor/ckeditor5-dev-bump-year)

Used to bump year for licence at the top of the file in specified path.
