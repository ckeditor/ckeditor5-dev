...
/**
 * Returns an empty collection for crawler errors.
 */
...
/**
 * Returns an error collector, which is called every time new error is found.
 */
export function createErrorCollector( errors: ErrorStore ): ( error: CrawlerError ) => void {
	return error => {
