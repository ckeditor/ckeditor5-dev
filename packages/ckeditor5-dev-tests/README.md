...
* `files` - Package names, directories or files to tests. Also available as an alias: `-f`. [See the docs for more details.](https://ckeditor.com/docs/ckeditor5/latest/framework/guides/contributing/testing-environment.html#rules-for-using-the-files-option)
